(define-module (polterguix systems babylon)
  #:use-module (gnu)
  #:use-module (gnu home)
...
(define system
  (operating-system
   ...
   (file-systems (cons* (file-system
                         (mount-point "/")
                         (device "/dev/mapper/cryptbabylon")
                         (type "ext4")
                         (dependencies mapped-devices))
                       (file-system
   ...
   (services
    (list (service home-zsh-service-type
          ...
          (simple-service 'dotfiles
                          ...
                          `(("hypr/hyprland.conf"  ,(local-file "../files/hypr/hyprland-babylon.conf"))
          ...
          (simple-service 'dotfiles
                          home-xdg-configuration-files-service-type
                          `(("waybar/style.css"  ,(local-file "../files/waybar/style-babylon.css"))
