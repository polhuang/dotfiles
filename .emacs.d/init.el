...
(use-package todoist
  :ensure t
  :init (load "~/.emacs.d/todoist-private.el")
  :bind (("C-c t" . todoist-task-menu))
  :custom
...
(custom-set-variables
 ...
 '(menu-bar-mode nil)
 '(org-agenda-files
   '("~/org/tasks.org" "~/org/schedule.org" "~/org/backmatter-tasks.org" "~/org/todoist.org"))
