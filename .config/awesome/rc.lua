--[[
   ...
   - install sp:
      ...
      - the search functionality above is outdated, see comments. this fork fixes it: https://github.com/CallMeRush/sp
      - install the spotify-shell widget from awesome-wm-widget repo
--]]
...
awful.spawn.with_shell(
    ...
    'dex --environment Awesome --autostart --search-paths "$XDG_CONFIG_DIRS/autostart:$XDG_CONFIG_HOME/autostart"' -- gzhttps://github.com/jceb/dex
)
--]]
...
globalkeys = mytable.join(
    ...
    awful.key({ altkey , modkey }, "space", function() naughty.destroy_all_notifications() end,
...
--              {description = "view  previous nonempty", group = "tag"}),
    ...
    -- Menu
    awful.key({ altkey,           }, "space", function () awful.util.mymainmenu:show() end,
...
-- enable titlebars when client is floating
-------------------------------------------------------------------------------
...
-- enable titlebars when layout is floating
-------------------------------------------------------------------------------
