...
theme.wallpaper                                 = theme.dir .. "/cherry.jpg"
...
theme.bg_focus                                  = "#454a5e"
theme.bg_urgent                                 = "#313131"
theme.border_width                              = dpi(5)
theme.border_normal                             = "#3F3F3F"
theme.border_focus                              = "#AEFFF0"
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.font(theme.font,
                          markup("#7AC82E", " " .. string.format("%06.0f", net_now.received))
                          .. " " ..
                          markup("#46A8C3", " " .. string.format("%06.0f", net_now.sent) .. " ")))
    end
})
